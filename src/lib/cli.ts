...
export function getAppEnv(): any {
    return {
        ...
        markdownitPlugins: {
            ...
            markdownitIns:      Markdown.mdiIns,
            markdownitMark:     Markdown.mdiMark,
            markdownitCheckbox: Markdown.mdiCheckbox,
            markdownitPlantuml: Markdown.mdiPlantUml,
            markdownitMath:     Markdown.mdiMath,
            markdownitImsize:   Markdown.mdiImsize,
            markdownitAnchor:   Markdown.mdiAnchor,
            markdownitToc:      Markdown.mdiToc,
            markdownitFootnote: Markdown.mdiFootNote,
            markdownitDeflist:  Markdown.mdiDefList,
            markdownitAbbr:     Markdown.mdiAbbr,
        },
